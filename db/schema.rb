...
ActiveRecord::Schema.define(version: 2021_08_16_182514) do
  ...
  create_table "seatings", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["flight_id"], name: "index_seatings_on_flight_id"
  end
  ...
  add_foreign_key "flights_users", "flights"
  add_foreign_key "flights_users", "users"
  add_foreign_key "seatings", "flights"
end
